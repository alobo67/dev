...
class _HomeState extends State<Home> {
  ...
  TextEditingController _controllerEmail = TextEditingController(text: "lobo.alfredo@gmail.com");
  ...
  _logarUsuario( Usuario usuario ){
    ...
    auth.signInWithEmailAndPassword(
      ...
      setState(() {
        _mensagemErro = "Erro ao autenticar usuáio, verifique e-mail e senha e tente novamente!";
      });
